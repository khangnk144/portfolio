...
A soft, airy one-page personal portfolio for Khang Nguyen, built with Vite, React, TypeScript, Tailwind CSS, Framer Motion, and Lucide icons.
...
Contact is GitHub-only: <https://github.com/khangnk144>.
